...
import { rutasOp } from '../Json/RutasDefecto';
...
export const MapaRutaDefecto = () => {
    ...
    return(
    < >
    <h1 className='text-3xl font-bold text-center mt-5 mb-5'>Mapa ruta por defecto</h1>
    <div id='map' className='w-full h-96 rounded-lg' />;

    <Link to={'/home'} className='font-bold text-3xl cursor-pointer'>Atras</Link>
    </>
    )
};
